 ...
 * Fetch comp vision analyses for admin dashboard
 * Production version - fetches real data from database
 */
export async function GET(request: NextRequest) {
  try {
    ...
    // Check if user has admin role - also check admin_profiles table
